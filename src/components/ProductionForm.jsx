...
<div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-4">
  ...
  {/* Primary Operator (Mandatory / 必填) */}
  <div className="space-y-2">
    <span className="block text-[11px] font-bold text-cyan-400 uppercase">
      PRIMARY OPERATOR <span className="text-rose-400">*</span>
    </span>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
      <div>
        ...
        <input
          ...
          className="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-sm text-cyan-300 font-mono font-bold focus:outline-none focus:border-cyan-400"
          required
        />
      </div>
      <div>
        <label className="block text-[10px] text-slate-400 mb-1 uppercase">PIN Code</label>
        <input
          type="password"
          maxLength={4}
          placeholder="••••"
  ...
  {/* Assistant Operator (Optional / 选填) */}
  <div className="space-y-2 pt-1 border-t border-slate-800/60">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
      <div>
        ...
        <input
          type="text"
          placeholder="Enter Assistant Employee ID"
          value={assistantOperatorId}
          onChange={(e) => setAssistantOperatorId(e.target.value)}
          className="w-full bg-slate-900 border border-slate-800 rounded-lg px-3 py-2 text-sm text-slate-300 font-mono focus:outline-none focus:border-slate-600"
        />
      </div>
      <div>
        <label className="block text-[10px] text-slate-500 mb-1 uppercase">PIN Code</label>
        <input
          type="password"
          maxLength={4}
          placeholder="••••"
